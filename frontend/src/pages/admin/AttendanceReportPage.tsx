...
const AttendanceReportPage: React.FC = () => {
  ...
  useEffect(() => {
    ...
    eventService
      ...
      .then(({ data }) => {
        ...
        setRecords(result?.report ?? MOCK_RECORDS);
      })
      .catch(() => {
        /* use mock */
      })
  ...
  const stats = {
    ...
    absent: records.filter(
      (r) => r.status === "absent" || r.status === "no_show",
    ).length,
  };
    ...
    <div className="p-6 max-w-5xl mx-auto space-y-5">
      ...
      <div className="flex items-start justify-between">
        <div>
          ...
          <p className="text-sm text-gray-500 mt-1">
            48-Hour Open Source Hackathon · Nov 5, 2025
          </p>
        </div>
        <Button
      ...
      <div className="flex flex-wrap items-center gap-3">
        ...
        <div className="flex gap-1.5 flex-wrap">
          {(["all", "present", "late", "absent", "no_show"] as const).map(
            (s) => (
              <button
                key={s}
              ...
              <thead>
                <tr className="border-b border-gray-100">
                  {[
                    ...
                    <th
                      key={h}
                      className="text-left text-xs font-semibold text-gray-400 uppercase px-5 py-4"
                    >
                      {h}
                    </th>
                  ))}
              ...
              <tbody className="divide-y divide-gray-50">
                {filtered.map((record) => (
                  ...
                  >
                    ...
                    <td className="px-5 py-3.5">
                      <Badge
                        variant={STATUS_CONFIG[record.status].badgeVariant}
