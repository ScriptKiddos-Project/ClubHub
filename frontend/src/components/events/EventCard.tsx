...
export const EventCard: React.FC<EventCardProps> = ({ event, variant = 'default' }) => {
  if (variant === 'featured') {
    return (
      <div className="relative bg-white rounded-2xl border border-gray-100 overflow-hidden group hover:shadow-lg transition-all duration-300 hover:-translate-y-0.5">
        <div className="relative h-48 bg-linear-to-br from-indigo-900 to-purple-900 overflow-hidden">
          {event.heroImageUrl && (
  ...
  return (
    <div className="relative bg-white rounded-2xl border border-gray-100 overflow-hidden group hover:shadow-md transition-all duration-200">
      <div className="relative h-36 bg-linear-to-br from-gray-700 to-gray-900 overflow-hidden">
        {event.heroImageUrl && (
